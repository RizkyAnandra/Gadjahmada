...
$komentar=trim($_POST['pesan']);
  $iden=mysqli_fetch_array(mysqli_query($query, "SELECT * FROM identitas"));
  
  $zali=mysqli_fetch_array(mysqli_query($query, "SELECT * FROM berita,komentar 
...
$username = $_POST['email'];
    ...
    $sql = mysqli_query($query, "INSERT INTO komentar(nama_komentar,
												isi_komentar,
												id_berita,
												tgl,
												jam_komentar,												
...
$row=mysqli_fetch_array(mysqli_query($query, "SELECT * FROM berita WHERE id_berita=$_POST[id]"));
