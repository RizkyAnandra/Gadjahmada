    ...
    <div class="shortcode-content"> 
     	<div class="gallery-preview">
									...
									<div class="gallery-thumbs">
										<ul>
                                        <?php
										$tampil = mysqli_query($query, "SELECT * FROM gallery ORDER BY id_gallery DESC LIMIT 1");
										 while($r=mysqli_fetch_array($tampil)){
											echo"<li class='active'>
											<a href='galeri-photo.html'><img src='img_galeri/kecil_$r[gbr_gallery]' height='60' width='80' class='setborder' alt='' /></a></li>";
											}?>
                                             <?php
										$tampil = mysqli_query($query, "SELECT * FROM gallery ORDER BY id_gallery DESC LIMIT 1,5");
										 while($r=mysqli_fetch_array($tampil)){
