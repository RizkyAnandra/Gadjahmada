 ...
 <!-- BEGIN .content-panel -->
								<div class="content-panel">
									...
									<div class="panel-content">
										...
										<?php
										$agenda=mysqli_query($query, "SELECT * FROM agenda ORDER BY id_agenda DESC LIMIT 1");	
										...
										<?php
										$agenda=mysqli_query($query, "SELECT * FROM agenda ORDER BY id_agenda DESC LIMIT 1,3");	
										while($t=mysqli_fetch_array($agenda)){
										echo"<li>
 ...
 <!-- BEGIN .content-panel -->
								<div class="content-panel">
									...
									<div class="panel-content">
										...
										<!-- BEGIN .article-big-block -->
										<?php
										$pengumuman=mysqli_query($query, "SELECT * FROM pengumuman ORDER BY id_pengumuman DESC LIMIT 1");	
										...
										<ul class="article-array content-category">
										<?php
										$pengumuman=mysqli_query($query, "SELECT * FROM pengumuman ORDER BY id_pengumuman DESC LIMIT 1,3");	
										while($t=mysqli_fetch_array($pengumuman)){
										echo"<li>
