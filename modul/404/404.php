  ...
  $populer=mysqli_query($query, "SELECT * FROM berita WHERE tanggal BETWEEN '$tgl_sebelumnya' AND '$hari_ini' 
  ...
  */ 
  ...
  $terkini2=mysqli_query("select youtube, dibaca, judul, judul_seo, jam, 
  ...
  $terkini=mysqli_query($query, "SELECT * FROM berita WHERE id_kategori ='41' ORDER BY id_berita DESC LIMIT 4");
  ...
  <div class="photos">
  <?php
  $pasangiklan=mysqli_query($query, "SELECT * FROM pasangiklan WHERE id_pasangiklan ORDER BY rand() DESC LIMIT 2");
