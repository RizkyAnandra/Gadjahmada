...
########## mysqli details (Replace with yours) #############
$db_username = "root"; //Database Username
$db_password = ""; //Database Password
$hostname = "localhost"; //mysqli Hostname
...
{
   /* connect to database using mysqlii */
	$mysqlii = new mysqlii($hostname, $db_username, $db_password, $db_name);
	
	if ($mysqlii->connect_error) {
		die('Error : ('. $mysqlii->connect_errno .') '. $mysqlii->connect_error);
	}
	
	//compare user id in our database
	$user_exist = $mysqlii->query("SELECT COUNT(google_id) as usercount FROM users WHERE google_id=$user_id")->fetch_object()->usercount; 
...
$mysqlii->query("INSERT INTO users (google_id, nama_lengkap, username, email, id_session, google_link, google_picture_link) 
