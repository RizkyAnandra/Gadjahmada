...
$result=mysqli_query($query, "select * from berita,kategori WHERE berita.id_kategori=kategori.id_kategori AND berita.id_berita<'$lastmsg' order by id_berita desc limit 2");
