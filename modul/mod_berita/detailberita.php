  ...
  <!-- Social icon -->
		<div class="main-content-left">
			<div class="content-article-title">
							    <?php                    
   $iklan=mysqli_query($query, "select * from tagline WHERE id_tagline = '2'"); 
...
<?php
	...
	$detail=mysqli_query($query, "SELECT * FROM berita,users,kategori    
...
";
mysqli_query($query, "UPDATE berita SET klik=$d[klik]+1 WHERE judul_seo='$_GET[judul]'");
	  if ($d['gambar']!=''){
...
mysqli_query($query, "UPDATE kategori SET diklik=$d[diklik]+1 where id_kategori='$d[id_kategori]'");

$tag = mysqli_query($query, "SELECT * FROM tag ORDER BY id_tag");
$ambil = mysqli_num_rows(mysqli_query("SELECT id_berita FROM berita"));
...
$an = mysqli_query($query, "SELECT count(id_berita) as jml, tag FROM berita WHERE
...
mysqli_query($query, "UPDATE rdb_tag SET jumlah =$kk[jml]
...
";  
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////
  $komentar = mysqli_query($query, "select count(komentar.id_komentar) as jml from komentar WHERE id_berita='$d[id_berita]' AND aktif='Y'");
...
echo"<div class='content-article-title'>
  ...
  $sql = mysqli_query($query, "SELECT * FROM komentar WHERE id_berita='$d[id_berita]' AND aktif='Y' LIMIT $posisi,$batas");
  ...
  $jmldata = mysqli_num_rows(mysqli_query($query, "SELECT * FROM komentar WHERE id_berita='$d[id_berita]' AND aktif='Y'"));
