  ...
  $detail=mysqli_query($query, "SELECT * FROM video,users,playlist WHERE users.username=video.username 
  ...
  $detail888=mysqli_query($query, "SELECT * FROM video WHERE id_video=$d[id_video]");
  ...
  mysqli_query($query, "UPDATE video SET dilihat=$d[dilihat]+1 
              WHERE id_video='$_GET[id]'");
			  
			  
  $komentar = mysqli_query
  ($query, "select count(komentarvid.id_komentar) as jml from komentarvid WHERE id_video='$_GET[id]' AND aktif='Y'");
  ...
  $sql = mysqli_query($query, "SELECT * FROM komentarvid WHERE id_video='$_GET[id]' AND aktif='Y' LIMIT $posisi,$batas");
  ...
  $jmldata     = mysqli_num_rows(mysqli_query($query, "SELECT * FROM komentarvid WHERE id_video='$_GET[id]' AND aktif='Y'"));
 ...
 <!------------- TABS BERITA -------------------->
  ...
  $sql=mysqli_query($query, "SELECT * FROM berita ORDER BY dibaca DESC LIMIT 5"); 
  ...
  <div class="list">
  <?php    
  $terkini=mysqli_query($query, "SELECT * FROM berita ORDER BY id_berita DESC LIMIT 5");
  ...
  <div class="list">
  <?php    
  $komentar=mysqli_query($query, "SELECT * FROM berita,komentar 
  ...
  <?php    
  $agenda=mysqli_query($query, "SELECT * FROM agenda ORDER BY rand() DESC LIMIT 6");
  ...
  <div class="list">
  <?php
  $tanya=mysqli_query($query, "SELECT * FROM poling WHERE aktif='Y' and status='Pertanyaan'");
  $t=mysqli_fetch_array($tanya);
  echo " <div class='poling1'>$t[pilihan]</div>";
  echo "<form method=POST action='hasil-poling.html'>";
  $poling=mysqli_query($query, "SELECT * FROM poling WHERE aktif='Y' and status='Jawaban'");
  ...
  <?php
  $album= mysqli_query($query, "SELECT jdl_album, album.id_album, gbr_album, album_seo,  
  ...
  <div class="photos">
  <?php
  $pasangiklan=mysqli_query($query, "SELECT * FROM pasangiklan ORDER BY rand() LIMIT 2");
