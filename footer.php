		...
		?>
					...
					<div class="footer-content">
						...
						<div class="footer-menu">
							<ul>
								 <?php    
		$sq = mysqli_query($query, "SELECT id_parent from kategori where id_parent='$_GET[id]'");
  		$n = mysqli_fetch_array($sq);           
        $khusus=mysqli_query($query, "SELECT * FROM kategori WHERE aktif='Y' AND id_parent='$n[id_parent]' Order By id_kategori DESC LIMIT 9");
