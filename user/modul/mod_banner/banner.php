...
<table id='dyntable' class='table table-bordered'>
   ...
   <tbody>";
	  ...
	  if ($_SESSION[leveluser]=='admin'){
      $tampil = mysqli_query("SELECT * FROM banner ORDER BY id_banner DESC");
    }
    else{
      $tampil=mysqli_query("SELECT * FROM banner
  ...
  break;
  case "editbanner":
    $edit = mysqli_query("SELECT * FROM banner WHERE id_banner='$_GET[id]'");
