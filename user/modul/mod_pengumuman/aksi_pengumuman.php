...
if ($module=='pengumuman' AND $act=='hapus'){
  $data=mysqli_fetch_array(mysqli_query($query, "SELECT gambar FROM pengumuman WHERE id_pengumuman='$_GET[id]'"));
  if ($data['gambar']!=''){
  mysqli_query($query, "DELETE FROM pengumuman WHERE id_pengumuman='$_GET[id]'");
...
elseif ($module=='pengumuman' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysqli_query($query, "INSERT INTO pengumuman(tema,
                                  tema_seo, 
                                  isi_pengumuman,                                  
                                  tgl_posting,                                  
                                  gambar, 
...
elseif ($module=='pengumuman' AND $act=='update'){
  ...
  if (empty($lokasi_file)){
  mysqli_query($query, "UPDATE pengumuman SET tema        = '$_POST[tema]',
                                 tema_seo    = '$tema_seo',
  ...
  header('location:../../media.php?module='.$module);
	...
	$data_gambar = mysqli_query($query, "SELECT gambar FROM pengumuman WHERE id_pengumuman='$_POST[id]'");
