...
switch($_GET[act]){
  ...
  echo"<div class='rightpanel'>
   ...
   <tbody>";
    ...
    $tampil = mysqli_query($query, "SELECT * FROM pengumuman ORDER BY id_pengumuman DESC");
	}
	else{
    $tampil=mysqli_query($query, "SELECT * FROM pengumuman WHERE username='$_SESSION[namauser]' ORDER BY id_berita DESC");}
	 $no = $posisi+1;
  ...
  case "editpengumuman":
    $edit = mysqli_query($query, "SELECT * FROM pengumuman WHERE id_pengumuman='$_GET[id]'");
