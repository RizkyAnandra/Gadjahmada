...
switch($_GET[act]){
  ...
  echo"<div class='rightpanel'>
   ...
   <tbody>";
    ...
    if ($_SESSION[leveluser]=='admin'){
      $tampil=mysqli_query($query, "SELECT * FROM sidebar ORDER BY id_sidebar DESC");
    }
    else{
      $tampil=mysqli_query($query, "SELECT * FROM sidebar 
  ...
  case "editsidebar":
    $edit = mysqli_query($query, "SELECT * FROM sidebar WHERE id_sidebar='$_GET[id]'");
