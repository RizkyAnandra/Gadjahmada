...
if ($module=='galerifoto' AND $act=='hapus'){
  $data=mysqli_fetch_array(mysqli_query($query, "SELECT gbr_gallery FROM gallery WHERE id_gallery='$_GET[id]'"));
  if ($data['gbr_gallery']!=''){
     mysqli_query($query, "DELETE FROM gallery WHERE id_gallery='$_GET[id]'");
...
elseif ($module=='galerifoto' AND $act=='input'){
 ...
 $gallery_seo = seo_title($_POST['jdl_gallery']);
  ...
  if (!empty($lokasi_file)){
   ...
   mysqli_query($query, "INSERT INTO gallery(jdl_gallery,
                                    gallery_seo,
                                    id_album,
									username,
                                    keterangan,
...
elseif ($module=='galerifoto' AND $act=='update'){
  ...
  if (empty($lokasi_file)){
     mysqli_query($query, "UPDATE gallery SET jdl_gallery  = '$_POST[jdl_gallery]',
  ...
  header('location:../../media.php?module='.$module);
	...
	$data_gbr_gallery= mysqli_query($query, "SELECT gbr_gallery FROM gallery WHERE id_gallery='$_POST[id]'");
