...
switch($_GET[act]){
  ...
  echo"<div class='rightpanel'>
   ...
   <th>Aksi</th>
    ...
    $tampil = mysqli_query($query, "SELECT * FROM gallery ORDER BY id_gallery DESC");}
	
    else{
    
    echo "<span class style=\"color:#FAFAFA;\">$_SESSION[namauser]</span>";
    $tampil = mysqli_query($query, "SELECT * FROM gallery,album WHERE gallery.id_album=album.id_album AND  
 ...
 <p class='stdformbutton'>
   ...
   break;
    ...
    $edit = mysqli_query($query, "SELECT * FROM gallery WHERE id_gallery='$_GET[id]'");
