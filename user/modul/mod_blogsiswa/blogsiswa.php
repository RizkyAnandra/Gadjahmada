...
<table id='dyntable' class='table table-bordered'>
   ...
   <tbody>";
	  ...
	  if ($_SESSION[leveluser]=='admin'){
      $tampil = mysqli_query($query, "SELECT * FROM blogsiswa ORDER BY id_blogsiswa DESC");
    }
    else{
      $tampil=mysqli_query($query, "SELECT * FROM blogsiswa
  ...
  break;
  case "editblogsiswa":
    $edit = mysqli_query($query, "SELECT * FROM blogsiswa WHERE id_blogsiswa='$_GET[id]'");
