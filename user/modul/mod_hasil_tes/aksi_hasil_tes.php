...
if ($module=='hasil_tes' AND $act=='hapus'){
     ...
     mysqli_query($query, "DELETE FROM hasil_tes WHERE id_hasil='$_GET[id]'");
...
$total = $_POST[skhun] + $_POST[tulis] + $_POST[wawancara];
    mysqli_query($query, "INSERT INTO hasil_tes(id_pendaftaran,
                                    skhun,
									tulis,
                                    wawancara,
									total) 
                            VALUES('$_POST[id_pendaftaran]',
								   ...
								   '$_POST[wawancara]',
								   '$total')");
mysqli_query($query, "UPDATE pendaftaran SET status       = 'S' 
...
$total = $_POST[skhun] + $_POST[tulis] + $_POST[wawancara];
    mysqli_query($query, "UPDATE hasil_tes SET skhun = '$_POST[skhun]',
										  tulis = '$_POST[tulis]',
