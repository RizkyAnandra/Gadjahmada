...
echo"<div class='rightpanel'>
   ...
   <tbody>";
    $tampil=mysqli_query($query, "SELECT * FROM hubungi ORDER BY id_hubungi DESC");
    $no = $posisi+1;
    ...
    echo "</tbody></table>";
    $jmldata=mysqli_num_rows(mysqli_query($query, "SELECT * FROM hubungi"));
  ...
  case "balasemail":
    $tampil = mysqli_query($query, "SELECT * FROM hubungi WHERE id_hubungi='$_GET[id]'");
