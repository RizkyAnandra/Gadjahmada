...
switch($_GET[act]){
  ...
  <tbody>";
   ...
   $tampil=mysqli_query($query, "SELECT * FROM berita,komentar WHERE komentar.id_berita=berita.id_berita AND berita.username='$_SESSION[namauser]' ORDER BY id_komentar DESC");
    $no = $posisi+1;
  ...
  echo "</table>";
    ...
    $jmldata=mysqli_num_rows(mysqli_query($query, "SELECT * FROM komentar"));
  ...
  case "editkomentar":
  $edit = mysqli_query($query, "SELECT * FROM komentar WHERE id_komentar='$_GET[id]'");
