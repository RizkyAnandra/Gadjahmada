...
if ($module=='agenda' AND $act=='hapus'){
  $data=mysqli_fetch_array(mysqli_query($query, "SELECT gambar FROM agenda WHERE id_agenda='$_GET[id]'"));
  if ($data['gambar']!=''){
  mysqli_query($query, "DELETE FROM agenda WHERE id_agenda='$_GET[id]'");
...
elseif ($module=='agenda' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysqli_query($query, "INSERT INTO agenda(tema,
                                  tema_seo, 
                                  isi_agenda,
                                  tempat,
                                  jam,
...
elseif ($module=='agenda' AND $act=='update'){
  ...
  if (empty($lokasi_file)){
  mysqli_query($query, "UPDATE agenda SET tema        = '$_POST[tema]',
                                 tema_seo    = '$tema_seo',
  ...
  header('location:../../media.php?module='.$module);
	...
	$data_gambar = mysqli_query($query, "SELECT gambar FROM agenda WHERE id_agenda='$_POST[id]'");
