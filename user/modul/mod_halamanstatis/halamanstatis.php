...
switch($_GET[act]){
  ...
  default:
   ...
   <tbody>";
    ...
    $tampil = mysqli_query($query, "SELECT * FROM halamanstatis ORDER BY id_halaman DESC");
  ...
  case "edithalamanstatis":
    $edit = mysqli_query($query, "SELECT * FROM halamanstatis WHERE id_halaman='$_GET[id]'");
