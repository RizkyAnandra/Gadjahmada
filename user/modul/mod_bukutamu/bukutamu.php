...
echo"<div class='rightpanel'>
   ...
   <tbody>";
    $tampil=mysqli_query($query, "SELECT * FROM bukutamu ORDER BY id_bukutamu DESC");
    $no = $posisi+1;
    ...
    echo "</tbody></table>";
    $jmldata=mysqli_num_rows(mysqli_query($query, "SELECT * FROM bukutamu"));
  ...
  case "balasemail":
    $tampil = mysqli_query($query, "SELECT * FROM bukutamu WHERE id_bukutamu='$_GET[id]'");
