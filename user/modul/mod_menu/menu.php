...
switch($_GET[act]){
  ...
  echo"<div class='rightpanel'>
   ...
   <tbody>";
    ...
    if ($_SESSION[leveluser]=='admin'){
      $tampil=mysqli_query($query, "SELECT * FROM menu ORDER BY id_menu DESC");
    }
    else{
      $tampil=mysqli_query($query, "SELECT * FROM menu 
 ...
 <option value='N' />Single Menu
  ...
  case "editmenu":
    $edit = mysqli_query($query, "SELECT * FROM menu WHERE id_menu='$_GET[id]'");
