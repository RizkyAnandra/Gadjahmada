...
switch($_GET[act]){
  ...
  echo"<div class='rightpanel'>
   ...
   <tbody>";
    ...
    if ($_SESSION[leveluser]=='admin'){
      $tampil=mysqli_query($query, "SELECT * FROM content ORDER BY id_content DESC");
    }
    else{
      $tampil=mysqli_query($query, "SELECT * FROM content 
  ...
  case "editcontent":
    $edit = mysqli_query($query, "SELECT * FROM content WHERE id_content='$_GET[id]'");
